...
| --- | --- | --- | --- |
| `npc:carian_speaker_101*` | `npc:finger_reader_crone` | 1.0 | “Your fingers, please… Reunite the half crescents at the Grand Lift.” |
...
| `npc:carian_speaker_213*` | `npc:smithing_master_hewg` | 1.0 | “Lay out your arms… I will smith as long as you like.” |
...
| `npc:carian_speaker_311*` | `npc:edgar` | 1.0 | “Irina... How could this be… The fault lies with me.” |
| `npc:carian_speaker_312*` | `npc:witch_hunter_jerren` | 1.0 | “Champions, welcome! The stars have aligned! The festival is nigh!” |
| `npc:carian_speaker_314*` | `npc:knight_diallos` | 1.0 | “The tale of House Hoslow is told in blood! I, Diallos, swear to deliver the message.” |
| `npc:carian_speaker_318*` | `npc:bloody_finger_hunter_yura` | 1.0 | “I am Yura, hunter of Bloody Fingers. Stay clear of Agheel Lake.” |
| `npc:carian_speaker_335*` | `npc:rhico_dreambrew_apostle` | 1.0 | “Perhaps you’ve heard of dreambrew, the nectar of the demigods?” |
...
| `npc:carian_speaker_801*` | `npc:imprisoned_merchant` | 1.0 | “Ahh, welcome… dear customer. Please, buy something. I’m hungry.” |

The full set of rows lives in `data/reference/entity_aliases.csv` and includes additional NPCs (Varre, Jar Bairn, Nepheli Loux, Merchant Kale, Brother Corhyn, Sorcerer Rogier, etc.). Comments on each row summarize the evidence trail for quick diff reviews. Buckets `npc:carian_speaker_31808*` and `npc:carian_speaker_31882*` stay mapped to `npc:shabriri`, while the remaining `318*` lines resolve to Yura.

## Newly introduced canonical slugs
- `npc:finger_reader_crone` captures the unnamed Finger Reader guides stationed at Stormveil bridge, the Altus highway lift, and Mountaintops approach. They cannot be collapsed into Enia, who remains confined to Roundtable Hold.
- `npc:rhico_dreambrew_apostle` represents the dreambrew-obsessed cleric in the Shadow of the Erdtree DLC who petitions St. Trina/Miquella and brews nectar from slumber fog.
...
| --- | --- | --- | --- |
| `npc:carian_speaker_303*` | `cut_content_guilbert_redeemer` | “I am Guilbert. A Redeemer of vengeance… Maybe you’re meant to be a Redeemer, too.” | Volcano Manor offshoot questlines referencing Redeemers, Godrick’s corpse, and Ordovis never shipped. Keep rows under a cut-content slug so downstream tools don’t fabricate a canonical NPC.
