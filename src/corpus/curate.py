...
class CorpusCurator:
    ...
    def _record_quality_report(self, dataset_name: str, df: pl.DataFrame) -> None:
        """Generate and track quality reports for a dataset."""

        summary = self.quality_reporter.profile(dataset_name, df)
